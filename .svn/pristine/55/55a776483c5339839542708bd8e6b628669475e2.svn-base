    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/start">SPT admin page</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                     <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="/users"><i class="fa  fa-underline  fa-fw"></i> Users Info</a>
                        </li>
                        <li>
                            <a href=""> <i class="fa fa-sitemap fa-fw"></i> Hub & Sensor <span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="/bbs"> <i class="fa fa-h-square fa"></i>  Hub</a>
                                </li>
                                <li>
                                    <a href="/sensor"> <i class="fa fa-weibo fa"></i>  Sensor</a>
                                </li>
                             </ul>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li> 
                                    <a href="/notice"><i class="fa fa-rss fa"></i> 공지사항 NOTICE</a>
                                </li>
                                <li>
                                    <a href="/freeboard"><i class="fa fa-comment fa"></i> 자유게시판 FREE BOARD</a>
                                </li>
                             </ul>
                        </li>
                    </ul>
        ...
        <div id="page-wrapper">
        	...
        	<header>Page denied   권한이 없습니다. 관리자에게 문의해 주세요!</header>
